...
set(stdout_log "/var/home/hoku/repo/tvm/build_riscv/3rdparty/tvm-ffi/libbacktrace/logs/project_libbacktrace-build.log")
set(stderr_log "/var/home/hoku/repo/tvm/build_riscv/3rdparty/tvm-ffi/libbacktrace/logs/project_libbacktrace-build.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /var/home/hoku/repo/tvm/build_riscv/3rdparty/tvm-ffi/libbacktrace/logs/project_libbacktrace-build-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "project_libbacktrace build command succeeded.  See also /var/home/hoku/repo/tvm/build_riscv/3rdparty/tvm-ffi/libbacktrace/logs/project_libbacktrace-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
